"""
Training script for models with NASA Loss
Modified trainer specifically for NASA scoring function
"""
...
from nasa_loss import NASALossDetailed
from metrics import evaluate_nasa_predictions


class NASATrainer:
    """Trainer class for models with NASA loss"""
    ...
    def __init__(self, model, train_loader, val_loader, test_loader,
        ...
        # Loss function
        self.criterion = NASALossDetailed(
    ...
    def evaluate_test(self):
        ...
        # Compute metrics
        metrics = evaluate_nasa_predictions(predictions, targets, censored)
